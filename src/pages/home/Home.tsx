...
function Home() {
    ...
    return (
        <Flex
            ...
            py={8}
        >
            <Heading size={{ base: '4xl' , md: '6xl' }} color="purple.900">
                Welcome to My Movie List
            </Heading>
            <Text fontSize="xl" mb={12} color="purple.700" >
                Find your new favorite movie today! 🎥
            </Text>

            <Flex align="center" justify="space-between" w="full" gap={5} position="relative" mb={8}>
                <Input
            ...
            {loading ? (
                <Flex justify="center" color="purple.950">
                <Spinner size="xl" />
                </Flex>
            ) : (
